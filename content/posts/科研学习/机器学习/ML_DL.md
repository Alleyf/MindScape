...
#### 2.3.1.7 7.随机数np.random

主要介绍创建ndarray随机数组以及随机打乱顺序、随机选取元素等相关操作的方法。

##### 2.3.1.7.1 创建随机ndarray数组
...
##### 2.3.1.9.1 推荐优先使用Paddle.Tensor的场景
...
#### 3.2.4.7 随机梯度下降法（ Stochastic Gradient Descent）
...
#### 3.3.6.1 使用Matplotlib库绘制损失随训练下降的曲线图
