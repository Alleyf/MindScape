...
title: "后端学习"
date: "2026-03-08"
tags: ["MySQL","Java","Redis","Linux"]
personality: "沉思者"
description: "后端开发学习笔记：Java、MySQL、Redis、Linux"
cover: "/images/covers/ms-fdf082b.svg"
---
...
#### 0.2.1.2 Try Catch Finally 捕捉处理异常
...
#### 0.2.3.4 ArrayList 和 LinkedList 的区别

ArrayList: 有顺序, 可重复
HashSet: 无顺序，不可重复

#### 0.2.3.5 HashMap 和 Hashtable 的区别
...
#### 0.2.3.6 HashSet LinkedHashSet TreeSet
...
#### 0.2.8.3 Execute 和 executeUpdate
...
##### 0.3.1.4.1 getField 和 getDeclaredField 的区别
