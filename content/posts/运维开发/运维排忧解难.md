...
tags: ["运维","DevOps"]
personality: "引路人"
description: "运维问题排查与解决手册"
cover: "/images/covers/ms-22ab3505.svg"
---
...
# 假设看到 2:0:0:0 对应 sda
echo 1 | sudo tee /sys/class/scsi_disk/2\:0\:0\:0/device/rescan
# 或者一条命令批量扫所有 scsi 盘
for i in /sys/class/scsi_disk/*/device/rescan; do echo 1 | sudo tee $i; done
# 扫完立即再执行
...
> 前提：
> 1. 待缩小的空间必须是磁盘末尾没有被分配使用的空余空间（eg：误扩容磁盘过大；新增的磁盘等）
> 2. 存储空间充足，足以克隆出一个原磁盘实际使用大小的容量。

#### 1.1.2.1 参考文献

[ESXi手动缩小vmdk虚拟机硬盘大小](https://www.imwxz.com/posts/ce878cfd.html#:~:text=Windows%E5%8F%AF%E4%BB%A5%E4%BD%BF%E7%94%A8%E8%87%AA%E5%B8%A6%E7%9A%84%E7%A3%81%E7%9B%98%E7%AE%A1%E7%90%86%E5%99%A8%E6%88%96%E8%80%85%E9%AB%98%E7%BA%A7%E4%B8%80%E7%82%B9%E7%9A%84DiskGenius%EF%BC%8C%E5%88%92%E5%88%86%E5%87%BA%E9%9C%80%E8%A6%81%E5%87%8F%E5%B0%91%E7%9A%84%E7%A3%81%E7%9B%98%E7%A9%BA%E9%97%B4%EF%BC%8C%E6%B3%A8%E6%84%8F%E5%8A%A1%E5%BF%85%E7%A1%AE%E4%BF%9D%E5%88%92%E5%88%86%E5%87%BA%E7%9A%84%E3%80%90%E6%9C%AA%E5%88%86%E9%85%8D%E3%80%91%E9%BB%91%E8%89%B2%E5%9D%97%E5%9C%A8%E6%9C%80%E5%8F%B3%E4%BE%A7%EF%BC%88%E7%A3%81%E7%9B%98%E5%B0%BE%EF%BC%89%E3%80%82%20%E5%86%8D%E6%AC%A1%20vi%20src.vmdk%EF%BC%8C%E5%B0%86RW%E9%82%A3%E4%B8%80%E8%A1%8C%E7%9A%84%E6%96%87%E4%BB%B6%E5%90%8D%E6%94%B9%E6%88%90,src-flat.vmdk%EF%BC%8C%E5%A6%82%E6%9E%9C%E6%9C%89%E5%A4%9A%E4%B8%80%E8%A1%8C%20deletable%20%E7%9A%84%E9%9C%80%E8%A6%81%E5%88%A0%E6%8E%89%E3%80%82%20%E5%9B%9E%E5%88%B0ESXi%E7%95%8C%E9%9D%A2%EF%BC%8C%E5%8F%B3%E5%87%BB%E3%80%90%E8%99%9A%E6%8B%9F%E6%9C%BA-%E5%BF%AB%E7%85%A7-%E6%95%B4%E5%90%88%E7%A1%AC%E7%9B%98%E3%80%91%EF%BC%8C%E7%84%B6%E5%90%8E%E8%BF%9B%E5%8E%BB%E5%88%B7%E6%96%B0%E4%B8%8B%E5%B0%B1%E8%83%BD%E7%9C%8B%E5%88%B0%E7%A1%AC%E7%9B%98%E5%B7%B2%E7%BB%8F%E7%BC%A9%E5%B0%8F%E4%BA%86~%20%E5%BC%80%E6%9C%BA%E6%B5%8B%E8%AF%95%E4%B8%8B%E5%B0%B1%E8%A1%8C%E4%BA%86)
[配置ssh连接Esxi、ESXi 收缩虚拟硬盘文件(.vmdk) 大小(回收ESXi thin磁盘空间)](https://blog.csdn.net/inthat/article/details/123125453)

#### 1.1.2.2 准备工作

1. **备份数据**：操作前务必对虚拟机进行完整备份（快照）
2. **确认工具**：
...
```bash
cd /vmfs/volumes/[datastore]/[VM目录]
vi src.vmdk  # 编辑非flat文件
```

1. **修改 vmdk 描述文件​
- 调整 `RW` 参数值（计算公式：目标 GB 数×1024³/512）

```bash
RW 268435456 VMFS "src.vmdk"  # 示例：128GB
```

- 更新 `ddb.geometry.cylinders`（参考值）：    
...
rm src.vmdk src-flat.vmdk
mv dest.vmdk src.vmdk
mv dest-flat.vmdk src-flat.vmdk
```

1. **修正文件引用**​
    - 再次编辑src.vmdk，确保指向 `src-flat.vmdk`
    - 删除可能存在的 `deletable` 行

#### 1.1.2.4 最终处理​

1. 在 ESXi 界面执行【虚拟机→快照→整合硬盘】
2. 重启虚拟机验证数据完整性
...
常见“罪魁祸首”：
- 日志文件：`*.log`、`journal`、`catalina.out`（Tomcat）
- 数据库 dump 文件：`*.sql`、`*.bak`
...
2. 参数解释：`drwxr-xr-x 10 root root 4.0K Feb 22 21:41 clash`
	...
	- 10：硬链接指向这个目录的个数，目录至少为 2（一个是 `.` 表示当前目录，另一个是 `..` 表示父目录），加上目录下文件和子目录的数量。
